...
//        if(herramientas1.formaElegida != 0 ||herramientas1.formaElegida != 1){
//             miForma.dibujate(bufferGraphics, evt.getX(), evt.getY(), new Trazo(jSlider1.getValue()));
//        } 
        if (herramientas1.formaElegida == 1) {
            miCirculo.dibujate(bufferGraphics, evt.getX(), new Trazo(jSlider1.getValue()));
            bufferGraphics.drawImage(buffer2, 0, 0, null);
        }
//       
        switch (herramientas1.formaElegida) {
            ...
            case -1:
                ...
                if (x1 != x2 || y1 != y2) {
                    bufferGraphics2.setColor(Color.WHITE);
                    bufferGraphics2.setStroke(new Trazo(30));
            ...
            case 0:
                ...
                if (x1 != x2 || y1 != y2) {
                    ...
                    bufferGraphics2.setStroke(new Trazo(jSlider1.getValue()));
                    bufferGraphics2.drawLine(x1, y1, x2, y2);
                    x1 = x2;
                    y1 = y2;
                }
            ...
            case 8:
                ...
                if (bPainting) {
                    for (int nPaint = 0; nPaint < 25; nPaint++) {
                        ...
                        bufferGraphics2.setColor(colores1.colorSeleccionado);
                        bufferGraphics2.drawOval(nX, nY, 1, 1);
    ...
    private void jPanel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MousePressed
        switch (herramientas1.formaElegida) {
            ...
            case 11:
                ...
                bufferGraphics2.drawString(herramientas1.textoDibujado, evt.getX(),evt.getY());
    ...
    private void jPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseReleased
        ...
        switch (herramientas1.formaElegida) {
            ...
            default:
                if (herramientas1.discontinuo == true) {
                    miForma.dibujate(bufferGraphics2, evt.getY(), evt.getX(), new Trazo(jSlider1.getValue(), true));
                } else {
                    miForma.dibujate(bufferGraphics2, evt.getY(), evt.getX(), new Trazo(jSlider1.getValue()));
                }
                bufferGraphics2.drawImage(buffer, 0, 0, null);
                bufferGraphics2.drawImage(buffer2, 0, 0, null);
